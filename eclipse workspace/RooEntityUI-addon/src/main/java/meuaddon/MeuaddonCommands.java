...
@Service
public class MeuaddonCommands implements CommandMarker { // All command types must implement the CommandMarker interface
	
	/**
	 * Get a reference to the MeuaddonOperations from the underlying OSGi container
	 */
	@Reference private MeuaddonOperations operations;
	 ...
	 */
	@CliAvailabilityIndicator({ "meuaddon setup", "meuaddon add", "meuaddon all" })
	 ...
	 * @param type 
	 */
	@CliCommand(value = "meuaddon add", help = "Some helpful description")
	 ...
	 * 
	 */
	@CliCommand(value = "meuaddon all", help = "Some helpful description")
	public void all() {
	 ...
	 * 
	 */
	@CliCommand(value = "meuaddon setup", help = "Setup Meuaddon addon")
	public void setup() {
		operations.setup();
	}
}